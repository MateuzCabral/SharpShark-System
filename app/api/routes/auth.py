...
async def login(login: LoginSchema, request: Request, session: Session = Depends(get_session)):
...
async def login_form(form: OAuth2PasswordRequestForm = Depends(), request: Request = None, session: Session = Depends(get_session)):
